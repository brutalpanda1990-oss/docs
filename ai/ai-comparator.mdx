...
<Frame caption="Analyse IA en cours : extraction des données depuis les devis PDF reçus.">
  <img src="/images/analyse-ia-offres.png" alt="Analyse IA des offres" />
</Frame>

<Frame caption="Aperçu des offres sous forme de cartes synthétiques générées par l'IA.">
  <img src="/images/comparateur-offres-carte.png" alt="Cartes synthétiques des offres" />
</Frame>

<Frame caption="Détail de l'analyse sémantique et du matching par article.">
  <img src="/images/comparateur-offres-analyse.png" alt="Extraction détaillée des offres" />
</Frame>
